	...
	| WHILE Triplet Regle
		{
			...
			{
				cout << "[ERREUR][SYNTAXIQUE] La postcondition de WHILE " << $2.postcondition.affirmation << " est différente de " << $2.programme.tantque.negation << "^" << $2.precondition.affirmation << endl;
			}
